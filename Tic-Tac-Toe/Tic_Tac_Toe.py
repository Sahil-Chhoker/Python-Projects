...
class TicTacToe:
    def __init__(self):
        ...
        self.restart_img = pygame.image.load('C:\MASTER FOLDER\GitHub\Python-Projects\Tic-Tac-Toe\images\RESTART.png').convert_alpha()
        self.win_img = pygame.image.load('C:\MASTER FOLDER\GitHub\Python-Projects\Tic-Tac-Toe\images\WIN.png').convert_alpha()
        self.lose_img = pygame.image.load('C:\MASTER FOLDER\GitHub\Python-Projects\Tic-Tac-Toe\images\LOSE.png').convert_alpha()
        self.draw_img = pygame.image.load('C:\MASTER FOLDER\GitHub\Python-Projects\Tic-Tac-Toe\images\DRAW.png').convert_alpha()
